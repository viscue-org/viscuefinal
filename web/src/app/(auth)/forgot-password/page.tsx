...
export default async function ForgotPasswordPage(props: {
  ...
  return (
    <main style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
      <div style={{ width: '100%', maxWidth: '400px', background: 'rgba(255, 255, 255, 0.04)', border: '1px solid rgba(255, 255, 255, 0.1)', borderRadius: '24px', padding: '32px' }}>
        ...
        {sent ? (
          <div role="status" style={{ background: 'rgba(91, 117, 147, 0.2)', border: '1px solid #5B7593', color: '#EDF2F6', padding: '16px', borderRadius: '18px', fontSize: '14px', lineHeight: 1.5, textAlign: 'center' }}>
